...
class ConversationManager:
    ...
    def get_response(
        ...
        if ai_mode == "✉️ Draft":
            contextual_prompt = get_email_generation_prompt(work_category, conversation_history)
        elif ai_mode == "📋 Plan":
            contextual_prompt = get_action_plan_prompt(work_category, conversation_history)
        elif ai_mode == "❓ Ask":
            contextual_prompt = get_questions_prompt(work_category, conversation_history)
